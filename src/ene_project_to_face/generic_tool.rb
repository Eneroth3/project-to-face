...
Sketchup.require "ene_project_to_face/ui_helper"
  ...
  module ProjectToFace
    ...
    class GenericTool
      ...
      def self.command
        ...
        UIHelper.attach_icons(command, tool_icon)
      ...
      def getInstructorContentDirectory
        "#{PLUGIN_ROOT}/instructors/#{self.class.tool_id}.html"
      end
    end
  end
end
